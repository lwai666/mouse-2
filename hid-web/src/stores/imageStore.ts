...
export const useImageStore = defineStore('image', () => {
  ...
  // Track if preloading has been completed
  ...
  async function preloadAll() {
    // Skip if already loading or already preloaded
    if (state.isLoading || isPreloaded.value) {
      console.log('[ImagePreload] Already preloaded, skipping...')
      return
    }
