...
import { ElAlert, ElButton, ElDropdown, ElDropdownItem, ElDropdownMenu, ElIcon, ElInputNumber, ElLoading, ElMessage, ElMessageBox, ElProgress, ElSlider, ElBadge } from 'element-plus'
...
import { ProfileType, Macro, ProfileInfoType, ConnectionType } from '~/types'
import { keyMap, useTransportWebHID, transportWebHID } from '~/utils/hidHandle'
...
function createConnection() {
  ...
  let _oldConnection: ConnectionType | undefined = undefined
...
<template>
  <div class="hid-container h-screen min-h-650px min-w-1050px w-screen flex items-center justify-center p-10px">
    ...
    <div class="middle-container relative h-full w-23% flex flex-col items-center">
      ...
      <div v-if="chargingStatus === 1" class="w-8 h-8" :class="profileInfo.battery_level == 100 ? 'color-green-500' : 'color-yellow-500'" draggable="false">
        <svg t="1751002332004" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="9714"><path d="M568 171.84v285.312h144.64a12.8 12.8 0 0 1 10.816 19.648l-243.84 382.208a12.8 12.8 0 0 1-23.616-6.848V566.848h-144.64a12.8 12.8 0 0 1-10.816-19.648l243.84-382.208a12.8 12.8 0 0 1 23.616 6.848z" fill="currentColor" fill-opacity=".88" p-id="9715"></path></svg>
      </div>
